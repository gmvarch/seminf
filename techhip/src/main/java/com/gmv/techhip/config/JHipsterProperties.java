...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "techhip@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "techhip API";

        private String description = "techhip API documentation";
