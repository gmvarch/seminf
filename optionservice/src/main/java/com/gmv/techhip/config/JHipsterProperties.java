...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "optionservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "optionservice API";

        private String description = "optionservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "optionservice";
