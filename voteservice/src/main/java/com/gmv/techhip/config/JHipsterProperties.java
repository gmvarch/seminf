...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "voteservice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "voteservice API";

        private String description = "voteservice API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "voteservice";
